...
public class LoansPage {
    ...
    private final SelenideElement creditByCashMobileLink = $x("//div[contains(text(), 'КРЕДИТ НАЛИЧНЫМИ')]/ancestor::a");
    ...
    public void openCashLoanDescriptionMobilePage() {
        creditByCashMobileLink.click();
    }
